...
(let* ((nbmax 64) (ldt (+ nbmax 1)) (zero 0.0) (one 1.0))
  (declare (type (f2cl-lib:integer4 64 64) nbmax)
   (type (f2cl-lib:integer4) ldt) (type (double-float 0.0 0.0) zero)
   (type (double-float 1.0 1.0) one) (ignorable nbmax ldt zero one))
                   ...
                   (f2cl-lib:fdo (i ilo (f2cl-lib:int-add i nb))
                                 ...
                                 (tagbody
                                     ...
                                     (dgemm "No transpose" "Transpose"
                                      ihi
                                      (f2cl-lib:int-add (f2cl-lib:int-sub ihi
                                                                          i
                                                                          ib)
                                                        1)
                                      ib (- one) work ldwork
