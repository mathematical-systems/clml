...
(let* ((zero 0.0) (one 1.0))
  ...
  (defun dgesvd (jobu jobvt m n a lda s u ldu vt ldvt work lwork info)
    ...
    (f2cl-lib:with-multi-array-data ((jobu character jobu-%data%
                                      jobu-%offset%)
                                     (jobvt character jobvt-%data%
                                      jobvt-%offset%)
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
             (anrm 0.0) (bignum 0.0) (eps 0.0) (smlnum 0.0) (bdspac 0)
             (blk 0) (chunk 0) (i 0) (ie 0) (ierr 0) (ir 0) (iscl 0)
             (itau 0) (itaup 0) (itauq 0) (iu 0) (iwork 0) (ldwrkr 0)
             (ldwrku 0) (maxwrk 0) (minmn 0) (minwrk 0) (mnthr 0)
             (ncu 0) (ncvt 0) (nru 0) (nrvt 0) (wrkbl 0) (lquery nil)
             (wntua nil) (wntuas nil) (wntun nil) (wntuo nil)
             (wntus nil) (wntva nil) (wntvas nil) (wntvn nil)
             (wntvo nil) (wntvs nil))
            (declare (type (double-float) anrm bignum eps smlnum)
             (type (array double-float (1)) dum)
             (type f2cl-lib:logical lquery wntua wntuas wntun wntuo
              wntus wntva wntvas wntvn wntvo wntvs)
             (type (f2cl-lib:integer4) bdspac blk chunk i ie ierr ir
              iscl itau itaup itauq iu iwork ldwrkr ldwrku maxwrk minmn
              minwrk mnthr ncu ncvt nru nrvt wrkbl))
            (setf info 0)
            (setf minmn
                  (min (the f2cl-lib:integer4 m)
                       (the f2cl-lib:integer4 n)))
            (setf mnthr
                  (ilaenv 6 "DGESVD" (f2cl-lib:f2cl-// jobu jobvt) m n
                   0 0))
            ...
            (cond ((not (or wntua wntus wntuo wntun)) (setf info -1))
                  ((or (not (or wntva wntvs wntvo wntvn))
                       (and wntvo wntuo))
                   (setf info -2))
                  ((< m 0) (setf info -3))
                  ((< n 0) (setf info -4))
                  ...
                  ((or (< ldvt 1) (and wntva (< ldvt n))
                   ...
                   (setf info -11)))
            (cond ((and (= info 0) (or (>= lwork 1) lquery) (> m 0)
                        (> n 0))
                   (cond ((>= m n)
                          ...
                          (cond ((>= m mnthr)
                                 (cond (wntun
                                        ...
                                        (setf maxwrk
                                              (max (the f2cl-lib:integer4
                                                   ...
                                                   (the f2cl-lib:integer4
                                                        (f2cl-lib:int-add (f2cl-lib:int-mul 3
                                                                                            n)
                                                                          (f2cl-lib:int-mul 2
                                                                                            n
                                                                                            (ilaenv
                                       ...
                                       ((and wntuo wntvn)
                                        ...
                                        (setf maxwrk
                                              (max (the f2cl-lib:integer4
                                                        (f2cl-lib:int-add (f2cl-lib:int-mul n
                                                                                            n)
                                                                          wrkbl))
                                                   (the f2cl-lib:integer4
                                                        (f2cl-lib:int-add (f2cl-lib:int-mul n
                                ...
                                (t
                                 (setf maxwrk
                                       (f2cl-lib:int-add (f2cl-lib:int-mul 3
                                                                           n)
                                                         (f2cl-lib:int-mul (f2cl-lib:int-add m
                                                                                             n)
                                                                           (ilaenv
                                                                            1
                                                                            "DGEBRD"
                          ...
                          (cond ((>= n mnthr)
                                 (cond (wntvn
                                       ...
                                       ((and wntvo wntun)
                                        ...
                                        (setf maxwrk
                                              (max (the f2cl-lib:integer4
                                                        (f2cl-lib:int-add (f2cl-lib:int-mul m
                                                                                            m)
                                                                          wrkbl))
                                                   (the f2cl-lib:integer4
                                                        (f2cl-lib:int-add (f2cl-lib:int-mul m
                   ...
                   (setf (f2cl-lib:fref work-%data% (1) ((1 *))
                                        work-%offset%)
                         (coerce (the f2cl-lib:integer4 maxwrk)
                                 'double-float))))
            (cond ((and (< lwork minwrk) (not lquery))
                   (setf info -13)))
            (cond ((/= info 0)
            ...
            (setf iscl 0)
            (cond ((and (> anrm zero) (< anrm smlnum))
                   (setf iscl 1)
            ...
            (cond ((>= m n)
                   (cond ((>= m mnthr)
                          (cond (wntun
                                 ...
                                 (multiple-value-bind (var-0 var-1
                                     ...
                                     (dgeqrf m n a lda
                                      ...
                                      (f2cl-lib:array-slice work
                                                            ...
                                                            (iwork)
                                                            ((1 *)))
                                      (f2cl-lib:int-add (f2cl-lib:int-sub lwork
                                                                          iwork)
                                                        1)
                                      ierr)
                                   (declare
                                 ...
                                 (setf itaup
                                       (f2cl-lib:int-add itauq n))
                                 (setf iwork
                                       (f2cl-lib:int-add itaup n))
                                 (multiple-value-bind (var-0 var-1
                                                       var-2 var-3
                                                       var-4 var-5
                                                       var-6 var-7
                                ...
                                ((and wntuo wntvn)
                                 (cond ((>= lwork
                                        ...
                                        (setf ir 1)
                                        (cond ((>= lwork
                                                   (f2cl-lib:int-add (max (the f2cl-lib:integer4
                                                                               wrkbl)
                                                                          (the f2cl-lib:integer4
                                                                               (f2cl-lib:int-add (f2cl-lib:int-mul lda
                                                                                                                   n)
                                                                                                 n)))
                                                                     (f2cl-lib:int-mul lda
                                                                                       n)))
                                               (setf ldwrku lda)
                                               (setf ldwrkr lda))
                                              ((>= lwork
                                        ...
                                        (setf itau
                                              (f2cl-lib:int-add ir
                                                                (f2cl-lib:int-mul ldwrkr
                                                                                  n)))
                                        (setf iwork
                                              (f2cl-lib:int-add itau
                                                                n))
                                        (multiple-value-bind (var-0
                                                              var-1
                                                              var-2
                                        ...
                                        (setf ie itau)
                                        (setf itauq
                                              (f2cl-lib:int-add ie n))
                                        (setf itaup
                                              (f2cl-lib:int-add itauq
                                                                n))
                                        (setf iwork
                                              (f2cl-lib:int-add itaup
                                                                n))
                                        (multiple-value-bind (var-0
                                                              var-1
                                                              var-2
                                       ...
                                       (wntvo
                                        (cond ((>= lwork
                                               ...
                                               (cond ((>= lwork
                                                     ...
                                                     ((>= lwork
                                                          (f2cl-lib:int-add wrkbl
                                                                            (f2cl-lib:int-mul (f2cl-lib:int-add lda
                                                                                                                n)
                                                                                              n)))
                                                      (setf ldwrku lda)
                                                      (setf ir
                  ...
                  (t
                   (cond ((>= n mnthr)
                          (cond (wntvn
                                 ...
                                 (setf itaup
                                       (f2cl-lib:int-add itauq m))
                                 (setf iwork
                                       (f2cl-lib:int-add itaup m))
                                 (multiple-value-bind (var-0 var-1
                                                       var-2 var-3
                                                       var-4 var-5
                                                       var-6 var-7
                                        ...
                                        (cond ((>= lwork
                                               ...
                                               (dgemm "N" "N" m n m one
                                                (f2cl-lib:array-slice work
                                                                      ...
                                                                      ((1
                                                                        *)))
                                                ldwrkr vt ldvt zero a
                                                lda)
                                               (dlacpy "F" m n a lda vt
                                                ldvt))
                                              (t
                                               (setf itau 1)
                                               (setf iwork
                                        ...
                                        (tagbody
                                            (setf (f2cl-lib:fref work-%data%
                                                  ...
                                                  (f2cl-lib:fref work-%data%
                                                                 ((f2cl-lib:int-sub (f2cl-lib:int-add i
                                                                                                      ie)
                                                                                    1))
                                                                 ((1
                                                                   *))
            ...
            (cond ((= iscl 1)
                   ...
                   (if (and (/= info 0) (> anrm bignum))
                       (multiple-value-bind (var-0 var-1 var-2 var-3
                                             var-4 var-5 var-6 var-7
                                             var-8 var-9)
                           (dlascl "G" 0 0 bignum anrm
                            (f2cl-lib:int-sub minmn 1) 1
                            (f2cl-lib:array-slice work double-float (2)
                                                  ((1 *)))
                            minmn ierr)
                         (declare
                          (ignore var-0 var-1 var-2 var-3 var-4 var-5
