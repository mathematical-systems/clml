  ...
  (defun dlasd6
    ...
    (declare (type (double-float) s c beta alpha)
     (type (array double-float (*)) work z difr difl poles givnum vl vf
      d)
     (type (array f2cl-lib:integer4 (*)) iwork givcol perm idxq)
     (type (f2cl-lib:integer4) info k ldgnum ldgcol givptr sqre nr nl
      icompq))
    (f2cl-lib:with-multi-array-data ((idxq f2cl-lib:integer4
                                     ...
                                     (work double-float work-%data%
                                      work-%offset%))
      (prog ((orgnrm 0.0) (i 0) (idx 0) (idxc 0) (idxp 0) (isigma 0)
             (ivfw 0) (ivlw 0) (iw 0) (m 0) (n 0) (n1 0) (n2 0))
            (declare (type (double-float) orgnrm)
             (type (f2cl-lib:integer4) i idx idxc idxp isigma ivfw ivlw
              iw m n n1 n2))
            (setf info 0)
            ...
            (cond ((or (< icompq 0) (> icompq 1)) (setf info -1))
                  ...
                  ((< ldgcol n) (setf info -14))
                  ((< ldgnum n) (setf info -16)))
            (cond ((/= info 0)
            ...
            (setf (f2cl-lib:fref d-%data% ((f2cl-lib:int-add nl 1))
                                 ((1 *)) d-%offset%)
                  zero)
            ...
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5
                ...
                (dlasd7 icompq nl nr sqre k d z
                 (f2cl-lib:array-slice work double-float (iw) ((1 *)))
                 vf
                 (f2cl-lib:array-slice work double-float (ivfw)
                                       ((1 *)))
                 vl
                 (f2cl-lib:array-slice work double-float (ivlw)
                                       ((1 *)))
                 alpha beta
                 (f2cl-lib:array-slice work double-float (isigma)
                                       ((1 *)))
                 (f2cl-lib:array-slice iwork f2cl-lib:integer4 (idx)
                                       ((1 *)))
                 (f2cl-lib:array-slice iwork f2cl-lib:integer4 (idxp)
                                       ((1 *)))
                 idxq perm givptr givcol ldgcol givnum ldgnum c s info)
              (declare
               (ignore var-0 var-1 var-2 var-3 var-5 var-6 var-7 var-8
                var-9 var-10 var-11 var-12 var-13 var-14 var-15 var-16
                var-17 var-18 var-20 var-21 var-22 var-23))
              (setf k var-4)
              (setf givptr var-19)
              (setf c var-24)
              (setf s var-25)
            ...
            (cond ((= icompq 1)
                   (dcopy k d 1
                    (f2cl-lib:array-slice poles double-float (1 1)
                                          ((1 ldgnum) (1 *)))
                    1)
                   (dcopy k
                    (f2cl-lib:array-slice work double-float (isigma)
                                          ((1 *)))
                    1
                    (f2cl-lib:array-slice poles double-float (1 2)
                                          ((1 ldgnum) (1 *)))
                    1)))
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5
                                  var-6 var-7 var-8 var-9)
            ...
            (go end_label)
       end_label (return (values nil nil nil nil nil nil nil alpha beta
                                 nil nil givptr nil nil nil nil nil nil
                                 nil nil k c s nil nil info))))))
  ...
  (setf (gethash 'fortran-to-lisp::dlasd6
        ...
        (fortran-to-lisp::make-f2cl-finfo :arg-types '((fortran-to-lisp::integer4)
          ...
          :return-values '(nil nil nil nil nil nil nil
                           fortran-to-lisp::alpha fortran-to-lisp::beta
                           nil nil fortran-to-lisp::givptr nil nil nil
                           nil nil nil nil nil fortran-to-lisp::k
                           fortran-to-lisp::c fortran-to-lisp::s nil
