  ...
  (defun dorgqr (m n k a lda tau work lwork info)
    ...
    (f2cl-lib:with-multi-array-data ((a double-float a-%data%
      ...
      (prog ((i 0) (ib 0) (iinfo 0) (iws 0) (j 0) (ki 0) (kk 0) (l 0)
             (ldwork 0) (lwkopt 0) (nb 0) (nbmin 0) (nx 0)
             (lquery nil))
            (declare (type f2cl-lib:logical lquery)
             (type (f2cl-lib:integer4) i ib iinfo iws j ki kk l ldwork
              lwkopt nb nbmin nx))
            (setf info 0)
            ...
            (cond ((and (>= nb nbmin) (< nb k) (< nx k))
                   ...
                   (setf kk
                         (min (the f2cl-lib:integer4 k)
                              (the f2cl-lib:integer4
                                   (f2cl-lib:int-add ki nb))))
                   (f2cl-lib:fdo (j (f2cl-lib:int-add kk 1)
            ...
            (if (< kk n)
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4
                                      var-5 var-6 var-7)
                    (dorg2r (f2cl-lib:int-sub m kk)
                     (f2cl-lib:int-sub n kk) (f2cl-lib:int-sub k kk)
                     (f2cl-lib:array-slice a double-float
                                           ((+ kk 1)
                                            (f2cl-lib:int-add kk 1))
                                           ((1 lda) (1 *)))
                     lda
                     (f2cl-lib:array-slice tau double-float ((+ kk 1))
                                           ((1 *)))
                     work iinfo)
                  (declare
