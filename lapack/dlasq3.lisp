...
(let* ((cbias 1.5)
  ...
  (let ((ttype 0)
        ...
        (dn2 zero)
        (tau zero))
    (declare (type (f2cl-lib:integer4) ttype)
     (type (double-float) dmin1$ dmin2 dn dn1 dn2 tau))
    (defun dlasq3
        (i0 n0 z pp dmin sigma desig qmax nfail iter ndiv ieee)
      (declare (type (double-float) qmax desig sigma dmin)
      ...
      (f2cl-lib:with-multi-array-data ((z double-float z-%data%
                                        z-%offset%))
        (prog ((eps 0.0) (s 0.0) (safmin 0.0) (t$ 0.0) (temp 0.0)
               (tol 0.0) (tol2 0.0) (ipn4 0) (j4 0) (n0in 0) (nn 0))
              (declare
               (type (double-float) eps s safmin t$ temp tol tol2)
                          ...
                          (* tol2
                             (+ sigma
                                (f2cl-lib:fref z-%data%
                                               ...
                                               ((1 *)) z-%offset%))))
                       (> (f2cl-lib:fref z-%data%
                                         ((f2cl-lib:int-sub (f2cl-lib:int-add nn
                                                                              (f2cl-lib:int-mul -1
                                                                                                2
                                                                                                pp))
                                                            4))
                          ...
                          (* tol2
                             (f2cl-lib:fref z-%data%
                                            ...
                                            ((1 *)) z-%offset%))))
                  (go label30))
         label20 (setf (f2cl-lib:fref z-%data%
              ...
              (go label10)
         label30 (if (and (> (f2cl-lib:fref z-%data%
         ...
         label40 (cond ((> (f2cl-lib:fref z
              ...
              (setf (f2cl-lib:fref z-%data%
                                   ...
                                   ((1 *)) z-%offset%)
                    (+ (f2cl-lib:fref z-%data%
                                      ((f2cl-lib:int-sub nn 3)) ((1 *))
                                      z-%offset%)
                       sigma))
              (setf n0 (f2cl-lib:int-sub n0 2))
              (go label10)
         label50 (cond ((or (<= dmin zero) (< n0 n0in))
                        (cond ((< (* cbias
                                     (f2cl-lib:fref z
                               ...
                               (setf (f2cl-lib:fref z-%data%
                                     ...
                                     (min (f2cl-lib:fref z-%data%
                                          ...
                                          (f2cl-lib:fref z-%data%
                                                         ...
                                                         z-%offset%)
                                          (f2cl-lib:fref z-%data%
                                                         ((f2cl-lib:int-add (f2cl-lib:int-sub (f2cl-lib:int-mul 4
                                                                                                                i0)
                                                                                              pp)
                                                                            4))
                                                         ((1 *))
         ...
         label70 (cond ((or (< dmin zero)
                        ...
                        (tagbody
                            (multiple-value-bind (var-0 var-1 var-2
                                                  ...
                                                  var-9 var-10 var-11
                                                  var-12)
                                (dlasq4 i0 n0 z pp n0in dmin dmin1$
                          ...
                          label80
                            (multiple-value-bind (var-0 var-1 var-2
                                                  ...
                                                  var-6 var-7 var-8
                                                  var-9 var-10 var-11)
                                (dlasq5 i0 n0 z pp tau dmin dmin1$
                                 dmin2 dn dn1 dn2 ieee)
                              (declare
                               (ignore var-0 var-1 var-2 var-3 var-4
                                var-11))
                              (setf dmin var-5)
                            ...
                            (cond ((and (>= dmin zero) (> dmin1$ zero))
                                  ...
                                  ((/= dmin dmin)
                                   ...
                                   (go label80))
                                  (t (go label90))))))
         label90 (multiple-value-bind (var-0 var-1 var-2 var-3 var-4
         ...
         label100 (cond ((< tau sigma)
              ...
              (setf sigma t$)
              (go end_label)
         end_label (return (values nil n0 nil nil dmin sigma desig qmax
                                   nfail iter ndiv nil)))))))
