...
(let* ((one 1.0) (zero 0.0))
  ...
  (defun dlasd1
    ...
    (declare (type (double-float) beta alpha)
     ...
     (type (array f2cl-lib:integer4 (*)) iwork idxq)
    ...
    (f2cl-lib:with-multi-array-data ((idxq f2cl-lib:integer4
                                     ...
                                     (work double-float work-%data%
                                      work-%offset%))
      (prog ((orgnrm 0.0) (coltyp 0) (i 0) (idx 0) (idxc 0) (idxp 0)
             (iq 0) (isigma 0) (iu2 0) (ivt2 0) (iz 0) (k 0) (ldq 0)
             (ldu2 0) (ldvt2 0) (m 0) (n 0) (n1 0) (n2 0))
            (declare (type (double-float) orgnrm)
             (type (f2cl-lib:integer4) coltyp i idx idxc idxp iq isigma
              iu2 ivt2 iz k ldq ldu2 ldvt2 m n n1 n2))
            (setf info 0)
            ...
            (setf ivt2
                  (f2cl-lib:int-add iu2 (f2cl-lib:int-mul ldu2 n)))
            (setf iq
                  (f2cl-lib:int-add ivt2 (f2cl-lib:int-mul ldvt2 m)))
            (setf idx 1)
            ...
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5
                ...
                (dlasd2 nl nr sqre k d
                 (f2cl-lib:array-slice work double-float (iz) ((1 *)))
                 alpha beta u ldu vt ldvt
                 (f2cl-lib:array-slice work double-float (isigma)
                                       ((1 *)))
                 (f2cl-lib:array-slice work double-float (iu2) ((1 *)))
                 ldu2
                 (f2cl-lib:array-slice work double-float (ivt2)
                                       ((1 *)))
                 ldvt2
                 ...
                 (f2cl-lib:array-slice iwork f2cl-lib:integer4 (idx)
                                       ((1 *)))
                 (f2cl-lib:array-slice iwork f2cl-lib:integer4 (idxc)
                                       ((1 *)))
                 idxq
                 (f2cl-lib:array-slice iwork f2cl-lib:integer4 (coltyp)
                                       ((1 *)))
                 info)
              (declare
               (ignore var-0 var-1 var-2 var-4 var-5 var-6 var-7 var-8
            ...
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5
                ...
                (dlasd3 nl nr sqre k d
                 (f2cl-lib:array-slice work double-float (iq) ((1 *)))
                 ldq
                 (f2cl-lib:array-slice work double-float (isigma)
                                       ((1 *)))
                 u ldu
            ...
            (go end_label)
       end_label (return (values nil nil nil nil alpha beta nil nil nil
  ...
  (setf (gethash 'fortran-to-lisp::dlasd1
        ...
        (fortran-to-lisp::make-f2cl-finfo :arg-types '((fortran-to-lisp::integer4)
          ...
          :return-values '(nil nil nil nil fortran-to-lisp::alpha
                           fortran-to-lisp::beta nil nil nil nil nil
