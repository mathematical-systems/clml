  ...
  (defun dlarfx (side m n v tau c ldc work)
    ...
    (f2cl-lib:with-multi-array-data ((side character side-%data%
                                     ...
                                     (work double-float work-%data%
                                      work-%offset%))
      (prog ((sum 0.0) (t1 0.0) (t10 0.0) (t2 0.0) (t3 0.0) (t4 0.0)
             (t5 0.0) (t6 0.0) (t7 0.0) (t8 0.0) (t9 0.0) (v1 0.0)
             (v10 0.0) (v2 0.0) (v3 0.0) (v4 0.0) (v5 0.0) (v6 0.0)
             (v7 0.0) (v8 0.0) (v9 0.0) (j 0))
            (declare
             (type (double-float) sum t1 t10 t2 t3 t4 t5 t6 t7 t8 t9 v1
              v10 v2 v3 v4 v5 v6 v7 v8 v9)
             (type (f2cl-lib:integer4) j))
            (if (= tau zero) (go end_label))
            (cond ((lsame side "L")
                   (tagbody
                       (f2cl-lib:computed-goto (label10 label30 label50
                                                label70 label90
                                                label110 label130
                                                label150 label170
                                                label190)
                                               m)
                       (dgemv "Transpose" m n one c ldc v 1 zero work
                        1)
                  ...
                  (t
                   (tagbody
                       (f2cl-lib:computed-goto (label210 label230
                                                label250 label270
                                                label290 label310
                                                label330 label350
                                                label370 label390)
                                               n)
                       (dgemv "No transpose" m n one c ldc v 1 zero
                        work 1)
