...
(let* ((maxit 20)
  ...
  (declare (type (f2cl-lib:integer4 20 20) maxit)
   (type (double-float 0.0 0.0) zero) (type (double-float 1.0 1.0) one)
  ...
  (defun dlasd4 (n i d z delta rho sigma work info)
    ...
    (f2cl-lib:with-multi-array-data ((d double-float d-%data%
      ...
      (prog ((dd (make-array 3 :element-type 'double-float))
             (zz (make-array 3 :element-type 'double-float)) (a 0.0)
             (b 0.0) (c 0.0) (delsq 0.0) (delsq2 0.0) (dphi 0.0)
             (dpsi 0.0) (dtiim 0.0) (dtiip 0.0) (dtipsq 0.0)
             (dtisq 0.0) (dtnsq 0.0) (dtnsq1 0.0) (dw 0.0) (eps 0.0)
             (erretm 0.0) (eta 0.0) (phi 0.0) (prew 0.0) (psi 0.0)
             (rhoinv 0.0) (sg2lb 0.0) (sg2ub 0.0) (tau 0.0) (temp 0.0)
             (temp1 0.0) (temp2 0.0) (w 0.0) (ii 0) (iim1 0) (iip1 0)
             (ip1 0) (iter 0) (j 0) (niter 0) (orgati nil) (swtch nil)
             (swtch3 nil))
            (declare
             (type (double-float) a b c delsq delsq2 dphi dpsi dtiim
              dtiip dtipsq dtisq dtnsq dtnsq1 dw eps erretm eta phi
              prew psi rhoinv sg2lb sg2ub tau temp temp1 temp2 w)
             (type f2cl-lib:logical orgati swtch swtch3)
             (type (array double-float (3)) dd zz)
                         ...
                         (f2cl-lib:fsqrt (+ (* (f2cl-lib:fref d-%data%
                                            ...
                                            (* rho
                                               ...
                                               (f2cl-lib:fref z-%data%
                                                              ...
                                                              ((1 *))
                                                              z-%offset%)))))
                   (setf (f2cl-lib:fref delta-%data% (1) ((1 *))
                                        delta-%offset%)
                         one)
            ...
            (cond ((= n 2)
                   (multiple-value-bind (var-0 var-1 var-2 var-3 var-4
                     ...
                     (declare
                      (ignore var-0 var-1 var-2 var-3 var-4 var-6))
                     (setf sigma var-5))
                   (go end_label)))
            ...
            (cond ((= i n)
                   ...
                   (setf w
                         (+ c
                            (/ (* (f2cl-lib:fref z-%data% (ii) ((1 *))
                                                 z-%offset%)
                                  (f2cl-lib:fref z-%data% (ii) ((1 *))
                                                 z-%offset%))
                               (* (f2cl-lib:fref delta-%data% (ii)
                                                 ((1 *))
                                                 delta-%offset%)
                                  (f2cl-lib:fref work-%data% (ii)
                                                 ((1 *))
                                                 work-%offset%)))
                            (/ (* (f2cl-lib:fref z-%data% (n) ((1 *))
                                  ...
                                  (f2cl-lib:fref z-%data% (n) ((1 *))
                                                 z-%offset%))
                               (* (f2cl-lib:fref delta-%data% (n)
                                                 ((1 *))
                                                 delta-%offset%)
                                  (f2cl-lib:fref work-%data% (n)
                                                 ((1 *))
                                                 work-%offset%)))))
                   (cond ((<= w zero)
                          (setf temp1
                   ...
                   (setf dphi (* temp temp))
                   (setf erretm
                         (+ (- (+ (* eight (- (- psi) phi)) erretm)
                               phi)
                            rhoinv (* (abs tau) (+ dpsi dphi))))
                   ...
                   (f2cl-lib:fdo (niter iter
                                  (f2cl-lib:int-add niter 1))
                                 ((> niter maxit) nil)
                                 (tagbody
                                     (cond ((<= (abs w) (* eps erretm))
                                            (go label240)))
                                     (setf dtnsq1
                                           (* (f2cl-lib:fref work-%data%
                                                             ((f2cl-lib:int-sub n
                  ...
                  (t
                   ...
                   (setf w
                         (+ c
                            (/ (* (f2cl-lib:fref z-%data% (i) ((1 *))
                                  ...
                                  (f2cl-lib:fref z-%data% (i) ((1 *))
                                                 z-%offset%))
                               (* (f2cl-lib:fref work-%data% (i)
                                                 ((1 *)) work-%offset%)
                                  (f2cl-lib:fref delta-%data% (i)
                                                 ((1 *))
                                                 delta-%offset%)))
                            (/ (* (f2cl-lib:fref z-%data% (ip1) ((1 *))
                                  ...
                                  (f2cl-lib:fref z-%data% (ip1) ((1 *))
                                                 z-%offset%))
                               (* (f2cl-lib:fref work-%data% (ip1)
                                                 ((1 *)) work-%offset%)
                                  (f2cl-lib:fref delta-%data% (ip1)
                                                 ((1 *))
                                                 delta-%offset%)))))
                   (cond ((> w zero)
                          ...
                          (setf a
                                (+ (* c delsq)
                                   (* (f2cl-lib:fref z-%data% (i)
                                                     ((1 *))
                                                     z-%offset%)
                                      (f2cl-lib:fref z-%data% (i)
                                                     ((1 *))
                                                     z-%offset%))
                                   (* (f2cl-lib:fref z-%data% (ip1)
                                                     ((1 *))
                                                     z-%offset%)
                                      (f2cl-lib:fref z-%data% (ip1)
                                                     ((1 *))
                   ...
                   (cond ((not swtch3)
                         ...
                         (t
                          (setf dtiim
                                (* (f2cl-lib:fref work-%data% (iim1)
                                                  ((1 *))
                                                  work-%offset%)
                                   (f2cl-lib:fref delta-%data% (iim1)
                                                  ((1 *))
                                                  delta-%offset%)))
                          (setf dtiip
                                (* (f2cl-lib:fref work-%data% (iip1)
                                                  ((1 *))
                                                  work-%offset%)
                                   (f2cl-lib:fref delta-%data% (iip1)
                                                  ((1 *))
                                                  delta-%offset%)))
                   ...
                   (f2cl-lib:fdo (niter iter
                                 ...
                                 (tagbody
                                                                ...
                                                                (* (f2cl-lib:fref z-%data%
                                                                   ...
                                                                   (f2cl-lib:fref z-%data%
                                                                                  ...
                                                                                  ((1
                                                                                    *))
                                                                                  z-%offset%)))))))
                                            (setf (f2cl-lib:fref dd (1)
                                                                 ((1
                                                                   3)))
                                                  dtiim)
                                            (setf (f2cl-lib:fref dd (2)
                                                                 ((1
                                                                   3)))
                                                  (* (f2cl-lib:fref delta-%data%
                                                                    (ii)
                                   ...
                                   label230))
                   (setf info 1)))
       label240 (go end_label)
       end_label (return (values nil nil nil nil nil nil sigma nil
                                 info))))))
