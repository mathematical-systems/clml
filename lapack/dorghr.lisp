  ...
  (defun dorghr (n ilo ihi a lda tau work lwork info)
    ...
    (f2cl-lib:with-multi-array-data ((a double-float a-%data%
                                     ...
                                     (work double-float work-%data%
                                      work-%offset%))
      (prog ((i 0) (iinfo 0) (j 0) (lwkopt 0) (nb 0) (nh 0)
             (lquery nil))
            (declare (type f2cl-lib:logical lquery)
             (type (f2cl-lib:integer4) i iinfo j lwkopt nb nh))
            (setf info 0)
                          ...
                          (tagbody
                              ...
                              (f2cl-lib:fdo (i (f2cl-lib:int-add ihi 1)
                                            ...
                                            (tagbody
                                              ...
                                              label30))
                            label40))
            (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1)) ((> j ilo) nil)
                          (tagbody
                              (f2cl-lib:fdo (i 1
                                             (f2cl-lib:int-add i 1))
                                            ((> i n) nil)
                              ...
                              (setf (f2cl-lib:fref a-%data% (j j)
                                    ...
                                    one)
                            label60))
            (f2cl-lib:fdo (j (f2cl-lib:int-add ihi 1)
                   ...
                   (multiple-value-bind (var-0 var-1 var-2 var-3 var-4
                       ...
                       (dorgqr nh nh nh
                        (f2cl-lib:array-slice a double-float
                                              ...
                                              ((1 lda) (1 *)))
                        lda
                        (f2cl-lib:array-slice tau double-float (ilo)
                                              ((1 *)))
                        work lwork iinfo)
                     (declare
