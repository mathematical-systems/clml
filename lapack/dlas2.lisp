...
(let* ((zero 0.0) (one 1.0) (two 2.0))
  ...
  (defun dlas2 (f g h ssmin ssmax)
    ...
    (prog ((as 0.0) (at 0.0) (au 0.0) (c 0.0) (fa 0.0) (fhmn 0.0)
           (fhmx 0.0) (ga 0.0) (ha 0.0))
                       ...
                       (t
                        ...
                        (cond ((= au zero)
                              ...
                              (t
                               ...
                               (setf ssmax (/ ga (+ c c)))))))))
          (go end_label)
     end_label (return (values nil nil nil ssmin ssmax)))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlas2
