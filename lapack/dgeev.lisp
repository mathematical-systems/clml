...
(let* ((zero 0.0) (one 1.0))
  ...
  (defun dgeev
    ...
    (f2cl-lib:with-multi-array-data ((jobvl character jobvl-%data%
                                      jobvl-%offset%)
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
             ...
             (scl 0.0) (smlnum 0.0) (sn 0.0) (hswork 0) (i 0) (ibal 0)
            ...
            (declare
             ...
             (type (f2cl-lib:integer4) hswork i ibal ierr ihi ilo itau
            ...
            (cond ((and (not wantvl) (not (lsame jobvl "N")))
                   (setf info -1))
            ...
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5
                ...
                (dgebal "B" n a lda ilo ihi
                 (f2cl-lib:array-slice work double-float (ibal)
                                       ((1 *)))
                 ierr)
                                            ...
                                            (f2cl-lib:fdo (k 1
                                                          ...
                                                          (tagbody
                                                              (setf (f2cl-lib:fref work-%data%
                                                                                   ((f2cl-lib:int-sub (f2cl-lib:int-add iwrk
                                                                                                                        k)
                                                                                                      1))
                                                                                   ((1
                                                                                     *))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgeev
