...
(let* ((zero 0.0) (half 0.5) (one 1.0) (multpl 4.0))
  ...
  (defun dlanv2 (a b c d rt1r rt1i rt2r rt2i cs sn)
    ...
    (prog ((aa 0.0) (bb 0.0) (bcmax 0.0) (bcmis 0.0) (cc 0.0) (cs1 0.0)
          ...
          (declare
           (type (double-float) aa bb bcmax bcmis cc cs1 dd eps p sab
          ...
          (cond ((= c zero) (setf cs one) (setf sn zero) (go label10))
                ...
                (t
                 ...
                 (cond ((>= z (* multpl eps))
                        (setf z
                              (+ p
                                 (f2cl-lib:sign (* (f2cl-lib:fsqrt scale)
                                                   (f2cl-lib:fsqrt z))
                                                p)))
                        (setf a (+ d z))
                       ...
                       (t
                        ...
                        (cond ((/= c zero)
                               (cond ((/= b zero)
                                      (cond ((= (f2cl-lib:sign one b)
                                                (f2cl-lib:sign one c))
                                             (setf sab
                                                   (f2cl-lib:fsqrt (abs b)))
                                             (setf sac
                                                   (f2cl-lib:fsqrt (abs c)))
                                             (setf p
                                                   (f2cl-lib:sign (* sab
                                                                     sac)
                                                                  c))
     ...
     label10 (setf rt1r a)
          ...
          (cond ((= c zero) (setf rt1i zero) (setf rt2i zero))
                (t
                 ...
                 (setf rt2i (- rt1i))))
          (go end_label)
     end_label (return (values a b c d rt1r rt1i rt2r rt2i cs sn)))))
