                                 ...
                                 (f2cl-lib:fdo (j 1
                                               ...
                                               (tagbody
                                                   (dcopy n
                                                    ...
                                                    1)
                                                 label10))
                                 (dtrmm "Right" "Lower" "No transpose"
                                        ...
                                        (dgemm "Transpose"
                                         ...
                                         (f2cl-lib:array-slice v
                                                               ...
                                                               ((1 ldv)
                                                                (1 *)))
                                         ldv one work ldwork)))
                                 (dtrmm "Right" "Upper" transt
                                  "Non-unit" n k one t$ ldt work
                                  ldwork)
                                 (cond ((> m k)
                                        (dgemm "No transpose"
                                         "Transpose"
                                         (f2cl-lib:int-sub m k) n k
                                         (- one)
                                         (f2cl-lib:array-slice v
                                                               double-float
                                                               ((+ k 1)
                                        ...
                                        (dgemm "No transpose"
                                         ...
                                         (f2cl-lib:array-slice v
                                                               ...
                                                               ((1 ldv)
                                                                (1 *)))
                                         ldv one work ldwork)))
                                 (dtrmm "Right" "Upper" trans
                                  "Non-unit" m k one t$ ldt work
                                  ldwork)
                                 (cond ((> n k)
                                        (dgemm "No transpose"
                                         "Transpose" m
                                         (f2cl-lib:int-sub n k) k
                                         (- one) work ldwork
                                         (f2cl-lib:array-slice v
                                                               double-float
                                                               ((+ k 1)
                         ...
                         (t
                          (cond ((lsame side "L")
                                 (f2cl-lib:fdo (j 1
                                               ...
                                               (tagbody
                                                   (dcopy n
                                                    ...
                                                    1)
                                                 label70))
                                 (dtrmm "Right" "Upper" "No transpose"
                                  "Unit" n k one
                                  (f2cl-lib:array-slice v double-float
                                                        ((+ m
                                                            (f2cl-lib:int-sub k)
                                                            1)
                                                         1)
                                 ...
                                 (cond ((> m k)
                                        (dgemm "Transpose"
                                         "No transpose" n k
                                         (f2cl-lib:int-sub m k) one c
                                         ldc v ldv one work ldwork)))
                                 (dtrmm "Right" "Lower" transt
                                  "Non-unit" n k one t$ ldt work
                                  ldwork)
                                 (cond ((> m k)
                                        (dgemm "No transpose"
                                         "Transpose"
                                         (f2cl-lib:int-sub m k) n k
                                         (- one) v ldv work ldwork one
                                         c ldc)))
                                 (dtrmm "Right" "Upper" "Transpose"
                                  "Unit" n k one
                                  (f2cl-lib:array-slice v double-float
                                                        ((+ m
                                                            (f2cl-lib:int-sub k)
                                ...
                                ((lsame side "R")
                                 ...
                                 (cond ((> n k)
                                        (dgemm "No transpose"
                                         "No transpose" m k
                                         (f2cl-lib:int-sub n k) one c
                                         ldc v ldv one work ldwork)))
                                 (dtrmm "Right" "Lower" trans
                                  "Non-unit" m k one t$ ldt work
                                  ldwork)
                                 (cond ((> n k)
                                        (dgemm "No transpose"
                   ...
                   (cond ((lsame direct "F")
                          (cond ((lsame side "L")
                                 ...
                                 (dtrmm "Right" "Upper" "Transpose"
                                  "Unit" n k one v ldv work ldwork)
                                 (cond ((> m k)
                                        (dgemm "Transpose" "Transpose"
                                         n k (f2cl-lib:int-sub m k) one
                                         (f2cl-lib:array-slice c
                                                               double-float
                                                               ((+ k 1)
                                                                1)
