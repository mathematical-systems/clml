...
(let* ((zero 0.0) (half 0.5) (one 1.0) (two 2.0) (four 4.0))
  ...
  (defun dlasv2 (f g h ssmin ssmax snr csr snl csl)
    ...
    (prog ((a 0.0) (clt 0.0) (crt 0.0) (d 0.0) (fa 0.0) (ft 0.0)
           (ga 0.0) (gt 0.0) (ha 0.0) (ht 0.0) (l 0.0) (m 0.0) (mm 0.0)
           (r 0.0) (s 0.0) (slt 0.0) (srt 0.0) (t$ 0.0) (temp 0.0)
           (tsign 0.0) (tt 0.0) (pmax 0) (gasmal nil) (swap nil))
          (declare
           (type (double-float) a clt crt d fa ft ga gt ha ht l m mm r
          ...
          (setf ssmin
                (f2cl-lib:sign ssmin
                               (* tsign (f2cl-lib:sign one f)
                                  (f2cl-lib:sign one h))))
          (go end_label)
     end_label (return (values nil nil nil ssmin ssmax snr csr snl
                               csl)))))
