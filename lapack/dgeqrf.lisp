...
(defun dgeqrf (m n a lda tau work lwork info)
  ...
  (f2cl-lib:with-multi-array-data ((a double-float a-%data% a-%offset%)
                                   ...
                                   (work double-float work-%data%
                                    work-%offset%))
    (prog ((i 0) (ib 0) (iinfo 0) (iws 0) (k 0) (ldwork 0) (lwkopt 0)
           (nb 0) (nbmin 0) (nx 0) (lquery nil))
          (declare (type f2cl-lib:logical lquery)
           (type (f2cl-lib:integer4) nx nbmin nb lwkopt ldwork k iws
            iinfo ib i))
          (setf info 0)
              ...
              (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5
                  ...
                  (dgeqr2 (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
                   ...
                   (f2cl-lib:array-slice a double-float (i i)
                                         ((1 lda) (1 *)))
                   lda
                   (f2cl-lib:array-slice tau double-float (i) ((1 *)))
                   work iinfo)
