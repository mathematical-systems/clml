...
(let* ((zero 0.0) (one 1.0))
  ...
  (defun dgesdd (jobz m n a lda s u ldu vt ldvt work lwork iwork info)
    ...
    (f2cl-lib:with-multi-array-data ((jobz character jobz-%data%
                                      jobz-%offset%)
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
             ...
             (blk 0) (chunk 0) (i 0) (ie 0) (ierr 0) (il 0) (ir 0)
             (iscl 0) (itau 0) (itaup 0) (itauq 0) (iu 0) (ivt 0)
             (ldwkvt 0) (ldwrkl 0) (ldwrkr 0) (ldwrku 0) (maxwrk 0)
             (minmn 0) (minwrk 0) (mnthr 0) (nwork 0) (wrkbl 0)
             (lquery nil) (wntqa nil) (wntqas nil) (wntqn nil)
             (wntqo nil) (wntqs nil))
            (declare (type (double-float) anrm bignum eps smlnum)
             (type (array double-float (1)) dum)
             (type f2cl-lib:logical lquery wntqa wntqas wntqn wntqo
              wntqs)
            ...
            (cond ((not (or wntqa wntqs wntqo wntqn)) (setf info -1))
                  ...
                  ((or (< ldu 1) (and wntqas (< ldu m))
                       (and wntqo (< m n) (< ldu m)))
                   (setf info -8))
                  ((or (< ldvt 1) (and wntqa (< ldvt n))
                       (and wntqs (< ldvt minmn))
                       (and wntqo (>= m n) (< ldvt n)))
                   (setf info -10)))
            (cond ((and (= info 0) (> m 0) (> n 0))
                   (cond ((>= m n)
                          (cond (wntqn
                                 ...
                                 (multiple-value-bind (var-0 var-1
                                   ...
                                   (declare
                                    (ignore var-0 var-1 var-2 var-3
                                     ...
                                     var-9 var-10 var-11 var-12))
                                   (setf info var-13))
                                 (dlaset "F" (f2cl-lib:int-sub m n)
                                  (f2cl-lib:int-sub m n) zero one
                                 ...
                                 (multiple-value-bind (var-0 var-1
                                   ...
                                   (declare
                                    (ignore var-0 var-1 var-2 var-3
                                     ...
                                     var-9 var-10 var-11 var-12))
                                   (setf info var-13))
                                 (dlaset "F" (f2cl-lib:int-sub n m)
                                  (f2cl-lib:int-sub n m) zero one
