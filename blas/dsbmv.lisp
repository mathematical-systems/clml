  ...
  (defun dsbmv (uplo n k alpha a lda x incx beta y incy)
    ...
    (f2cl-lib:with-multi-array-data ((uplo character uplo-%data%
                                     ...
                                     (y double-float y-%data%
                                      y-%offset%))
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0)
             (kplus1 0) (kx 0) (ky 0) (l 0) (temp1 0.0) (temp2 0.0))
            (declare (type (double-float) temp1 temp2)
             (type (f2cl-lib:integer4) i info ix iy j jx jy kplus1 kx
              ky l))
            (setf info 0)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dsbmv
