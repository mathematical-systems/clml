...
(let* ((zero (f2cl-lib:cmplx 0.0 0.0)))
  ...
  (defun zhpr2 (uplo n alpha x incx y incy ap)
    (declare (type (simple-array character (*)) uplo)
     ...
     (type (array f2cl-lib:complex16 (*)) ap y x)
     (type (f2cl-lib:integer4) incy incx n))
    (f2cl-lib:with-multi-array-data ((x f2cl-lib:complex16 x-%data%
                                      x-%offset%)
                                     (y f2cl-lib:complex16 y-%data%
                                      y-%offset%)
                                     (ap f2cl-lib:complex16 ap-%data%
                                      ap-%offset%)
                                     (uplo character uplo-%data%
                                      uplo-%offset%))
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0) (k 0)
             (kk 0) (kx 0) (ky 0) (temp1 #C(0.0 0.0))
             (temp2 #C(0.0 0.0)))
            (declare (type (f2cl-lib:complex16) temp1 temp2)
             (type (f2cl-lib:integer4) i info ix iy j jx jy k kk kx
              ky))
            (setf info 0)
                                            ...
                                            (cond ((or (/= (f2cl-lib:fref x
                                                   ...
                                                   (setf (f2cl-lib:fref ap-%data%
                                                                        ...
                                                                        ((1
                                                                          *))
                                                                        ap-%offset%)
                                                         (coerce (+ (f2cl-lib:dble (f2cl-lib:fref ap-%data%
                                                                                                  ((f2cl-lib:int-sub (f2cl-lib:int-add kk
                                                                                                                                       j)
                                                                                                                     1))
                                                                                                  ((1
                                                  ...
                                                  (t
                                                   (setf (f2cl-lib:fref ap-%data%
                                                         ...
                                                         (coerce (f2cl-lib:dble (f2cl-lib:fref ap-%data%
                                                                 ...
                                                                 'f2cl-lib:complex16))))
                                            (setf kk
                                                  (f2cl-lib:int-add (f2cl-lib:int-sub (f2cl-lib:int-add kk
                                                                                                        n)
                                                                                      j)
                                                                    1))
                                          label60)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zhpr2
