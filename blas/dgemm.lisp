...
(let* ((one 1.0) (zero 0.0))
  ...
  (defun dgemm (transa transb m n k alpha a lda b ldb$ beta c ldc)
    ...
    (f2cl-lib:with-multi-array-data ((transa character transa-%data%
                                      transa-%offset%)
      ...
      (prog ((temp 0.0) (i 0) (info 0) (j 0) (l 0) (ncola 0) (nrowa 0)
            ...
            (setf info 0)
            (cond ((and (not nota) (not (lsame transa "C"))
                        (not (lsame transa "T")))
                   (setf info 1))
                  ((and (not notb) (not (lsame transb "C"))
                        (not (lsame transb "T")))
                   (setf info 2))
                  ((< m 0) (setf info 3))
                  ((< n 0) (setf info 4))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgemm
