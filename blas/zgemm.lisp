...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  ...
  (defun zgemm (transa transb m n k alpha a lda b ldb$ beta c ldc)
    (declare (type (simple-array character (*)) transb transa)
    ...
    (f2cl-lib:with-multi-array-data ((a f2cl-lib:complex16 a-%data%
                                     ...
                                     (c f2cl-lib:complex16 c-%data%
                                      c-%offset%)
                                     (transa character transa-%data%
                                      transa-%offset%)
                                     (transb character transb-%data%
                                      transb-%offset%))
      (prog ((temp #C(0.0 0.0)) (i 0) (info 0) (j 0) (l 0) (ncola 0)
             (nrowa 0) (nrowb 0) (conja nil) (conjb nil) (nota nil)
             (notb nil))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zgemm
