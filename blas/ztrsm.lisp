...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  ...
  (defun ztrsm (side uplo transa diag m n alpha a lda b ldb$)
    (declare (type (simple-array character (*)) diag transa uplo side)
    ...
    (f2cl-lib:with-multi-array-data ((a f2cl-lib:complex16 a-%data%
      ...
      (prog ((temp #C(0.0 0.0)) (i 0) (info 0) (j 0) (k 0) (nrowa 0)
            ...
            (setf info 0)
            (cond ((and (not lside) (not (lsame side "R")))
                   (setf info 1))
                                                                 ...
                                                                 (tagbody
                                                                     (cond ((/= (f2cl-lib:fref a
                                                                            ...
                                                                            (cond (noconj
                                                                                  ...
                                                                                  (t
                                                                                   (setf temp
                                                                                         (coerce (f2cl-lib:dconjg (f2cl-lib:fref a-%data%
                                                                                                                                 (j
                                                                                                                                  k)
                                                                                                                                 ((1
                                                                                                                                   lda)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::ztrsm
